...
export const Azul = {
  ...
  name: 'Huevo Azul',
  description: 'El huevo azul es un huevo exclusivo que sólo estaba disponible al comienzo de la Actualización de Mascotas en Adopt Me!. Fue el primer huevo junto con el huevo rosa. Sólo puede eclosionar en un perro azul poco común. Ahora sólo se puede obtener a través del comercio con otros jugadores.',
...
export const Comun = {
  ...
  description: 'El huevo de mascota es un huevo raro y está disponible para siempre en la guardería. Es más probable que se convierta en una mascota poco común (35%). Todas las mascotas que no pertenecen a un huevo limitado o a una mascota de un pase de juego están disponibles en este huevo, como el dragón, el Gato de las nieves y el perro, por nombrar a algunos. Su apariencia es un huevo completamente blanco, liso, sin otros accesorios ni detalles. Los jugadores pueden comprárselo a Holly, la amante de los gatos en la guardería.',
  content: ['Gato - 100%'], 
  rarity: 'Común',
  cost: '600'
};
